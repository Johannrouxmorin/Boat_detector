...
class CNN_145(nn.Module):
    def __init__(self, num_classes):
        super(CNN_145, self).__init__()
        self.encoder = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=3, padding=1),
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
...
class CNN_581(nn.Module):
    def __init__(self, num_classes):
        super(CNN_581, self).__init__()
        self.encoder = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=3, padding=1),
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
        ...
        self.decoder = nn.Sequential(
            nn.ConvTranspose2d(8192, 4096, kernel_size=2, stride=2),
            nn.BatchNorm2d(4096),
            nn.ReLU(inplace=True),
